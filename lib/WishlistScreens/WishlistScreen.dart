...
class WishlistScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Wishlist",style: kAppBarTitleStyle,),
      ),
                ...
                itemBuilder: (context,index){
                  return Dismissible(
                    ...
                    background: Padding(
                      ...
                      child: ListTile(
                        trailing: Icon(Icons.delete,color: kRedColor,),
                      ),
                    ),
                    child: Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              width: double.infinity,
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage('https://source.unsplash.com/random/300?1'),fit: BoxFit.cover),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      //   ],
                                      // ),
                                      child: Center(child: Text('Add To Cart',style: kSubHeadingText.copyWith(fontSize: 12),)),
                                    ),
                                  ),
                                ],
                              ),
